-- Safe Migration Script - Can be run multiple times
...
DROP TRIGGER IF EXISTS update_customer_stories_updated_at ON public.customer_stories;
...
-- Create indexes (IF NOT EXISTS available in newer PostgreSQL versions)
...
DROP POLICY IF EXISTS "Public can view published customer stories" ON public.customer_stories;
DROP POLICY IF EXISTS "Public can view open jobs" ON public.jobs;
DROP POLICY IF EXISTS "Anyone can insert page views" ON public.page_views;
DROP POLICY IF EXISTS "Authenticated users can view all users" ON public.users;
DROP POLICY IF EXISTS "Authenticated users can view all content" ON public.posts;
DROP POLICY IF EXISTS "Authenticated users can create content" ON public.posts;
DROP POLICY IF EXISTS "Authenticated users can update their content" ON public.posts;
DROP POLICY IF EXISTS "Authenticated users can manage services" ON public.services;
DROP POLICY IF EXISTS "Authenticated users can manage customer stories" ON public.customer_stories;
DROP POLICY IF EXISTS "Authenticated users can manage jobs" ON public.jobs;
DROP POLICY IF EXISTS "Authenticated users can manage media" ON public.media_files;
...
BEGIN
  ...
  RAISE NOTICE 'You can now run the data migration script: npm run migrate:supabase';
END $$;
