      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <a href="/admin/posts/create" className="w-full p-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all flex items-center gap-3">
                <FaFileAlt />
                <span>Tạo bài viết mới</span>
              </a>

              <a href="/admin/services/create" className="w-full p-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-3">
                <FaServicestack />
                <span>Thêm dịch vụ mới</span>
              </a>

              <a href="/admin/services" className="w-full p-4 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all flex items-center gap-3">
                <FaUsers />
                <span>Quản lý dịch vụ</span>
              </a>

              <a href="/admin/posts" className="w-full p-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all flex items-center gap-3">
                <FaNewspaper />
                <span>Quản lý bài viết</span>
              </a>

              <a href="/admin/settings" className="w-full p-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-lg hover:from-gray-700 hover:to-gray-800 transition-all flex items-center gap-3">
                <FaCog />
