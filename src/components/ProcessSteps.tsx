          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 sm:top-16 left-full w-6 sm:w-8 h-0.5 bg-gradient-to-r from-primary-300 to-transparent z-0"></div>
              )}
              
              <div className="card-mobile hover:shadow-xl transition-all duration-300 group-hover:scale-105 relative z-10 h-full">
                {/* Step Number */}
                <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-primary-600 text-white rounded-full font-bold text-base sm:text-lg mb-4 sm:mb-6 mx-auto group-hover:bg-primary-700 transition-colors">
                  {step.number}
                </div>

                {/* Icon */}
                <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-primary-100 rounded-full text-primary-600 mb-4 sm:mb-6 mx-auto group-hover:bg-primary-200 transition-colors">
                  {step.icon}
                </div>
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="bg-gradient-to-r from-primary-600 to-blue-600 rounded-2xl p-6 sm:p-8 lg:p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/lien-he" 
                className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-6 sm:px-8 rounded-lg transition-colors inline-flex items-center justify-center"
              >
              ...
              <a 
                ...
                className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-semibold py-3 px-6 sm:px-8 rounded-lg transition-colors inline-flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
