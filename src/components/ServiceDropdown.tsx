...
export default function ServiceDropdown({ isOpen }: ServiceDropdownProps) {
  ...
  return (
    <div className="absolute top-full left-0 mt-1 w-80 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 animate-in slide-in-from-top-5 duration-300">
      <div className="p-4">
        <div className="space-y-2">
          {featuredServices.map((service, index) => (
            <Link
              ...
              className="flex items-center p-4 rounded-xl hover:bg-primary-50 hover:text-primary-700 transition-all duration-300 group hover:scale-[1.02] min-h-[68px] cursor-pointer"
              style={{
